...
echo "  - ✅ Tenant database: /app/server/data/tenants/${INSTANCE_NAME}/kanban.db"
echo "  - ✅ Tenant attachments: /app/server/attachments/tenants/${INSTANCE_NAME}/"
echo "  - ✅ Tenant avatars: /app/server/avatars/tenants/${INSTANCE_NAME}/"
echo "  - ✅ Namespace: ${NAMESPACE} (shared by all tenants)"
echo "  - ✅ Deployment: easy-kanban (shared by all tenants)"
echo "  - ✅ SQLite Proxy: sqlite-proxy (shared by all tenants)"
